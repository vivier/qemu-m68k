...
static const float32 exp_tbl2[64] = {
    make_float32(0x00000000),
    make_float32(0x9F841A9B),
    make_float32(0x9FC1D5B9),
    make_float32(0xA0728369),
    make_float32(0x1FC5C95C),
    make_float32(0x1EE85C9F),
    make_float32(0x9FA20729),
    make_float32(0xA07BF9AF),
    make_float32(0xA0020DCF),
    make_float32(0x205A63DA),
    make_float32(0x1EB70051),
    make_float32(0x1F6EB029),
    make_float32(0xA0781494),
    make_float32(0x9EB319B0),
    make_float32(0x2017457D),
    make_float32(0x1F11D537),
    make_float32(0x9FB952DD),
    make_float32(0x1FE43087),
    make_float32(0x1FA2A818),
    make_float32(0x1FDE494D),
    make_float32(0x20504890),
    make_float32(0xA073691C),
    make_float32(0x1F9B7A05),
    make_float32(0xA0797126),
    make_float32(0xA071A140),
    make_float32(0x204F62DA),
    make_float32(0x1F283C4A),
    make_float32(0x9F9A7FDC),
    make_float32(0xA05B3FAC),
    make_float32(0x1FDF2610),
    make_float32(0x9F705F90),
    make_float32(0x201F678A),
    make_float32(0x1F32FB13),
    make_float32(0x20038B30),
    make_float32(0x200DC3CC),
    make_float32(0x9F8B2AE6),
    make_float32(0xA02BBF70),
    make_float32(0xA00BF518),
    make_float32(0xA041DD41),
    make_float32(0x9FDF137B),
    make_float32(0x201F1568),
    make_float32(0x1FC13A2E),
    make_float32(0xA03F8F03),
    make_float32(0x1FF4907D),
    make_float32(0x9E6E53E4),
    make_float32(0x1FD6D45C),
    make_float32(0xA076EDB9),
    make_float32(0x9FA6DE21),
    make_float32(0x1EE69A2F),
    make_float32(0x207F439F),
    make_float32(0x201EC207),
    make_float32(0x9E8BE175),
    make_float32(0x20032C4B),
    make_float32(0x2004DFF5),
    make_float32(0x1E72F47A),
    make_float32(0x1F722F22),
    make_float32(0xA017E945),
    make_float32(0x1F401A5B),
    make_float32(0x9FB9A9E3),
    make_float32(0x20744C05),
    make_float32(0x1F773A19),
    make_float32(0x1FFE90D5),
    make_float32(0xA041ED22),
    make_float32(0x1F853F3A),
};
...
static const float32 pi_tbl2[65] = {
    make_float32(0x21800000),
    make_float32(0xA0D00000),
    make_float32(0xA1E80000),
    make_float32(0x21480000),
    make_float32(0xA1200000),
    make_float32(0x21FC0000),
    make_float32(0x21100000),
    make_float32(0xA1580000),
    make_float32(0x21E00000),
    make_float32(0x20B00000),
    make_float32(0xA1880000),
    make_float32(0x21C40000),
    make_float32(0x20000000),
    make_float32(0x21380000),
    make_float32(0xA1300000),
    make_float32(0x9FC00000),
    make_float32(0x21000000),
    make_float32(0xA1680000),
    make_float32(0xA0A00000),
    make_float32(0x20900000),
    make_float32(0x21600000),
    make_float32(0xA1080000),
    make_float32(0x1F800000),
    make_float32(0xA0B00000),
    make_float32(0x20800000),
    make_float32(0xA0200000),
    make_float32(0x20E00000),
    make_float32(0x1F000000),
    make_float32(0x20000000),
    make_float32(0x20600000),
    make_float32(0x1F800000),
    make_float32(0x1F000000),
    make_float32(0x00000000),
    make_float32(0x9F000000),
    make_float32(0x9F800000),
    make_float32(0xA0600000),
    make_float32(0xA0000000),
    make_float32(0x9F000000),
    make_float32(0xA0E00000),
    make_float32(0x20200000),
    make_float32(0xA0800000),
    make_float32(0x20B00000),
    make_float32(0x9F800000),
    make_float32(0x21080000),
    make_float32(0xA1600000),
    make_float32(0xA0900000),
    make_float32(0x20A00000),
    make_float32(0x21680000),
    make_float32(0xA1000000),
    make_float32(0x1FC00000),
    make_float32(0x21300000),
    make_float32(0xA1380000),
    make_float32(0xA0000000),
    make_float32(0xA1C40000),
    make_float32(0x21880000),
    make_float32(0xA0B00000),
    make_float32(0xA1E00000),
    make_float32(0x21580000),
    make_float32(0xA1100000),
    make_float32(0xA1FC0000),
    make_float32(0x21200000),
    make_float32(0xA1480000),
    make_float32(0x21E80000),
    make_float32(0x20D00000),
    make_float32(0xA1800000),
};
