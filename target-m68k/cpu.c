...
static void m68k_cpu_reset(CPUState *s)
{
    ...
    env->fp0h = floatx80_default_nan(NULL).high;
    env->fp0l = floatx80_default_nan(NULL).low;
    env->fp1h = floatx80_default_nan(NULL).high;
    env->fp1l = floatx80_default_nan(NULL).low;
